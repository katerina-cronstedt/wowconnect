...
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'hq_team';
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'city_team';
...
-- =============================================
-- VOLUNTEER ENHANCEMENTS (Phase 3.5)
-- =============================================
...
CREATE POLICY "Enable read access for event_volunteers" ON public.event_volunteers FOR SELECT TO authenticated USING (true);
CREATE POLICY "Enable insert access for hq_admin" ON public.event_volunteers FOR INSERT TO authenticated WITH CHECK (public.is_hq_admin());
CREATE POLICY "Enable delete access for hq_admin" ON public.event_volunteers FOR DELETE TO authenticated USING (public.is_hq_admin());
